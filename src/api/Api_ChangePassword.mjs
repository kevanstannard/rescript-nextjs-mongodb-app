...
function handlePost(req, res) {
  ...
  if (body !== undefined) {
    ...
    if (currentUserId !== undefined) {
      return Server_User.changePassword(match.client, Caml_option.valFromOption(currentUserId), body).then(function (changePasswordResult) {
                  var result;
                  result = changePasswordResult.TAG === /* Ok */0 ? ({
                        result: "Ok",
